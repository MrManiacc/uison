...
public class PongUI extends UIBlock {
    ...
    private UIConstraint replayConstraint = new UIConstraint().setYConst(new StickyConstraint(TOP, new PixelConstraint(50))).setXConst(new CenterConstraint());
    ...
    private UIFlex createCameraInfo() {
        ...
        UIFlex infoBox = new UIVBox(10, 10, 10, 10).fill(UIColor.DARK_PURPLE);
